$(document).ready(function () {
    ...
    if ($(Window).width() >= 992) {
        $('.navigation-bar .links-bar .main-links .nav-item.has-sub').hover(function () {
            ...
            var itemShift = $(window).width() - ($(this).offset().left + $(this).outerWidth()) - (parseInt($('.navigation-bar .links-bar .container').css('margin-left')));
            ...
            if ($(this).hasClass('active')) {
                ...
                // Toggle the sub menu
                $(`.navigation-bar .links-bar .sub-menu.${subMenu} .sub-items`).css(`padding-right`, `${itemShift}px`);
